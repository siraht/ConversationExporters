...
export type PageOperation = "claudeList" | "claudeDetail" | "geminiList" | "geminiExtract";
...
export interface SyncSummary { provider: Provider; discovered: number; fetched: number; unchanged: number; retained: number }
